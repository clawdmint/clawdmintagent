...
import type { NetworkFamily } from "@/lib/network-config";

type IconProps = SVGProps<SVGSVGElement>;

export function BaseLogo({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 111 111"
      fill="none"
...
export function SolanaLogo({ className, ...props }: IconProps) {
...
export function NetworkLogo({
  ...
  className,
  ...props
}: IconProps & { family: NetworkFamily }) {
  if (family === "solana") {
    return <SolanaLogo className={className} {...props} />;
  }

  return <BaseLogo className={className} {...props} />;
}
