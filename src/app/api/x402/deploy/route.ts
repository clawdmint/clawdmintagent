  ...
  discovery: {
    ...
    input: {
      ...
      bodyFields: {
        ...
        image: { type: "string", description: "HTTPS, IPFS, or data:image collection cover image. cover_image is also accepted.", required: false },
        cover_image: { type: "string", description: "Explicit mint page and collection cover image. Alias for image.", required: false },
        ...
        items: { type: "array", description: "Inline core_collection item metadata; length must match max_supply. Items may include attributes, rarity_rank, rarity_score, rarity, animation_url, and properties.", required: false },
